...
#' @export
MySummaryCpp <- function(vecIn) {
    .Call(`_LeapFrog_MySummaryCpp`, vecIn)
}
...
dbeta4 <- function(x, min, max, shape1, shape2, gap = 0) {
    .Call(`_LeapFrog_dbeta4`, x, min, max, shape1, shape2, gap)
}
...
pbeta4 <- function(q, min, max, shape1, shape2, gap = 0) {
    .Call(`_LeapFrog_pbeta4`, q, min, max, shape1, shape2, gap)
}

#' @export
#' @rdname beta4
qbeta4 <- function(p, min, max, shape1, shape2) {
    .Call(`_LeapFrog_qbeta4`, p, min, max, shape1, shape2)
}

#' @export
#' @rdname beta4
rbeta4 <- function(n, min, max, shape1, shape2) {
    .Call(`_LeapFrog_rbeta4`, n, min, max, shape1, shape2)
}

rcpp_hello_world <- function() {
    .Call(`_LeapFrog_rcpp_hello_world`)
}
